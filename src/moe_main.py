...
from moe_model_final import MoERecommender
from mod_trainers import CoSeRecTrainer
...
def main():
    ...
    parser.add_argument("--hidden_size_Gat", type=int, default=128,
                        help="the input and output hidden size for Gat (embedding size)")
    parser.add_argument("--n_layers", type=int, default=2, help="number of layers")
    parser.add_argument("--n_layers_Gat", type=int, default=2, help="number of layers for Gat")
    ...
    parser.add_argument("--rec_weight", type=float, default=1.0, help="weight of recommended learning task")
    parser.add_argument("--aux_weight", type=float, default=0.1, help="weight of MOE loss")
    ...
    model = MoERecommender(args=args)
